...
# 1 "/opt/microchip/mplabx/v5.45/packs/Microchip/PIC16F1xxxx_DFP/1.5.133/xc8/pic/include/inline.h" 1 3
...
# 645 "/opt/microchip/xc8/v2.31/pic/sources/c99/common/doprnt.c"
...
static int vfpfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        flags = width = 0;
        prec = -1;
# 1296 "/opt/microchip/xc8/v2.31/pic/sources/c99/common/doprnt.c"
        if ((*fmt[0] == 'x') || (*fmt[0] == 'X')) {
